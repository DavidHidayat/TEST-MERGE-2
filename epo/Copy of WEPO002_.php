                                ...
                                <div class="control-group">	
                                    <table class="table-non-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="control-label" for="newPrCharged">New Charged BU: </label>
                                                <div class="controls">
                                    ...
                                    ?>
                                        <tr id="<?php echo $seqItemSession;?>">
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                    /**if($supplierCdSession != 'SUP99' && $itemCdSession != '99'){
                                                        $query3 = "select 
                                                                        APP_STATUS_CD 
                                                                        ,APP_STATUS_NAME
                                                                        ,APP_STATUS_ALIAS
                                                    ...
                                                    if($supplierCdSession != 'SUP99' && $itemCdSession != '99' && $itemCount > 1)
                                                    {
                                                        $query3 .= "and APP_STATUS_CD in ('1110','1120','1130','1140')";
                                                    }
                                                    else if ($supplierCdSession == 'SUP99' && $itemCdSession == '99' && $itemCount > 1)
                                                    {
