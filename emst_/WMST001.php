<?php session_start(); 
include $_SERVER['DOCUMENT_ROOT']."/EPS_TRIAL_OCT/db/PDOdb.php";
include $_SERVER['DOCUMENT_ROOT']."/EPS_TRIAL_OCT/db/Constant.php";
include $_SERVER['DOCUMENT_ROOT']."/EPS_TRIAL_OCT/db/Common.php";
include $_SERVER['DOCUMENT_ROOT']."/EPS_TRIAL_OCT/db/CONTROLLER/PAGING.php";
