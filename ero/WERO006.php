...
<html>
    <head>
        ...
        <script src="../js/ero/WERO006.js"></script>
        <title>EPS</title>
    </head>
    <body> 
    </body>
                ...
                <div class="span12"> 
                    ...
                    ?>
                        ...
                        <div class="widget widget-table action-table">
                            <div class="widget-header"> <i class="icon-minus-sign"></i>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                {
                                                    if(($roStatusName == 'Open' && $totalReceivedQty > 0 && $totalOpenQty < $qty ) 
                                                            || $roStatusName == 'Closed' )
                                                    {
                                            ?>
                                                        <a href="../db/Redirect/RO_Screen.php?criteria=roDetailCancel&paramRefTransferId=<?php echo $refTransferId;?>&paramPoNo=<?php echo $poNo?>" class="faq-list">
                                                            <?php echo $itemName;?>
                                                        </a>
                                            <?php             
                                                    }
