<?php
function roSendMailReceived ($prNo, $mailTo, $mailFrom, $mailFromName, $getParamLink, $mailSubject, $mailMessage){
...
//    $mail->Username   = "srinindito@denco.co.id";     // SMTP server username
    ...
    $cc = "muh.iqbal@taci.toyota-industries.com";
    $mail->AddBCC($cc);
...
function roSendMailReopened ($poNo, $mailTo, $mailFrom, $mailFromName, $getParamLink, $mailSubject, $mailMessage){
    $mail = new PHPMailer(true); //New instance, with exceptions enabled
...
//    
    ...
    $body = $body . $mailMessage;
    $body = $body . "<font face='Trebuchet MS' size='-1'><br>Please follow the link below :<br>";  
    $body = $body . "<a href='http://".$_SERVER['HTTP_HOST']."/EPS/db/Login/RO_MAIL_LOGIN.php?".$getParamLink."'>"."Click to open the Document"."</a></font>";
    $body = $body . "<font face='Trebuchet MS' size='-2'><i> (** This link contains your user id and password to EPS, please do not forward this email for your secure. If you want to forward this email, please remove this link first before send.)</i></font>";
