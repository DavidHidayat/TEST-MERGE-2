...
{      
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        $sPrScreen  = $_SESSION['EPSAuthority'];
        
        if($sPrScreen == 'EPSTakeOverPrScreen')
        { 
...
<html>
    <head>
        ...
        <script src="../js/epr/WEPR005.js"></script>
        <script>
            maximize();
        </script>
        <title>EPS</title>
            ...
            <div class="row">
                <div class="span12">  
                        ...
                        <div class="alert alert-success" id="success-msg" style="display: none">
                            <strong>Success!</strong> Takeover PR finished.
                        </div>
...
<div id="dialog-confirm-takeover" title="Confirm" style="display: none;"></div>
    </body>
</html>
