...
class PDF_MC_Table extends FPDF
{
        function Header()
        {
            ...
            {  
                //Logo
                $this->Image('fpdf16/tutorial/hdi.jpg',10,10,35);
	...
	function NbLines($w,$txt)
	{
        ...
        function headerTabelItem()
        {
            ...
            $this->Cell(35,7,'Nama Barang','LTR',0,'C',1); 
            $this->Cell(40,7,'Part No, Spec, Ukuran/Dimensi,','LTR',0,'C',1); 
            $this->Cell(23,7,'Merk','LTR',0,'C',1); 
...
while($row = $sql->fetch(PDO::FETCH_ASSOC))
{
	...
	$pdf->SetWidths(array(7,16,98,15,16,10,10,7,25,25,25,23));
        $pdf->SetAligns(array('C','L','L','L','L','C','R','C','R','R','L','L'));
	$pdf->Row(array($no,$prNo,$itemName,$deliveryDate,$prCharged,$itemType,$qty,$unitCd,$itemPrice,$amount,$supplierName,$remark));
}
$pdf->SetTextColor(0,0,0);
