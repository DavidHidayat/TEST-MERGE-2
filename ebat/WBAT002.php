...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="86400; url=WBAT002.php">
        ...
        <script>
            $(function() {
				...
				for(var i=0; i < plantCdArray.length; i++)
				{
					...
					$.ajax({
						type: 'GET',
						//url: '../db/CREATE_FILE/CREATE_OUTSTANDING_PO_FILE.php',
                        url: '../db/REPORT/OUTSTANDING_PO.php?action=SentOutstandingPo',
						data: eDataPo,
    ...
    <body> 
        <p>
            This screen has purpose for Sending Outstanding PO to Supplier for each day.
        </p>
        <p>
