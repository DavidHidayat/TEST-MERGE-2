    ...
    <head>
        ...
        var mainLayout = function(){
            ...
            var groupingFeature = Ext.create ('Ext.grid.feature.Grouping',{
                groupHeaderTpl: 'PLANT: {name} ({rows.length} Item{[values.rows.length > 1? "s" : ""]})'
            });
            /** 
             * =======================================
             * Define Pr Procurement PIC Master Grid
             * =======================================
             **/
            var PrProcApproverMstGrid = new Ext.grid.GridPanel({
                title: 'PR Procurement PIC Master',
                store: dsPrProcApproverMstPaging,
