...
{   
    ...
    if($sUserId != '')
    {
        ...
        if($sRoleId == 'ROLE_02' || $sRoleId == 'ROLE_03' || $sRoleId == 'ROLE_04' || $sRoleId == 'ROLE_06')
        {
            ...
            <div class="row">
                <div class="span12"> 
                    ...
                    <div class="form-actions">
                        ...
                        <button class="btn btn-inverse" id="btn-update" disabled>Update PO</button> 
                    ...
                    <div class="alert alert-success" id="close-msg" style="display: none">
                        <strong>Success!</strong> Update PO finished and PO Close.
                    </div>
                    
                    <form>
                        <!---------------------------------- Hidden Parameter --------------------------------->
                        <input type="hidden" id="countApp" value="<?php echo $getCountApprover; ?>" />
                        <input type="hidden" id="initialCountApp" value="<?php echo $getCountApprover; ?>" />
                                    ...
                                    <table class="table-non-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="controls">
                                                    <input type="text" id="issuedBy" class="span4" maxlength="200" value="<?php echo $issuedName; ?>" readonly />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <div class="widget-content">
                                <table class="table table-striped table-bordered" id="poItemTable">
                                    ...
                                    {  
                                        ...
                                        $totalReceivingSession  = $poDetails['totalReceiving'];
                                        ...
                                        <tr id="<?php echo $seqPoItemSession;?>">
                                            ...
                                            <td style="display: none">
                                                <?php echo $totalReceivingSession;?>
                                            </td>
                                        </tr>
                                        <?
                                        }
...
<div id="dialog-form" title="Edit PO Item" style="display: none;">
    ...
    <div class="alert" id="dialog-mandatory-msg-3" style="display: none">
        <strong>Existence Error!</strong> Selected supplier does not match for this PO.
    </div>
    <div class="alert" id="dialog-mandatory-msg-4" style="display: none">
        <strong>Range Error!</strong> Please input qty >= received qty.
    </div>
        ...
        <form id="WEPO014Form-dialog">
            <div class="widget-content">
                <div class="control-group">
                    ...
                    <input type="hidden" id="itemStatusHidden" />
                    <input type="hidden" id="totalReceivedHidden" />
