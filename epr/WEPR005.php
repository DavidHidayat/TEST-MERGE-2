...
{       
    ...
    $prNo       = $_GET['prNo'];
    if($_SESSION['EPSAuthority'] != 'EPSTakeOverPrScreen')
    {       
    ?>
    ...
    <head>
        ...
        var mainLayout = function(){
            var toolbarTop = new Ext.Toolbar ({
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        text: 'Main Screen',
                        handler: function(){
                            Ext.Msg.alert('Message','Sorry, you cannot change menu during in Takeover PR Screen. <br>Please choose action "Takeover PR or Return".');
                        }   
                    }]
                },{
                    xtype: 'buttongroup',
                    ...
                    items: [{
                        ...
                        text: 'PR Waiting',
                        handler: function(){
                            Ext.Msg.alert('Message','Sorry, you cannot change menu during in Takeover PR Screen. <br>Please choose action "Takeover PR or Back".');
                        }
                    },{
                        xtype: 'button',
                        text: 'Create New PR',
            ...
            function updatePr(me){
                Ext.Msg.confirm('Confirm', 'Are you sure want to '+me+' ?', function(btn, text){
                    if (btn == 'yes'){
                        Ext.Ajax.request({
                            method: 'POST',
                            url: '../db/PR/UPDATE_PR.php?action=takeOverPr',
                            params: {
            ...
            var panelCenter = Ext.create('Ext.form.Panel', {
                border: false,
                frame: true,
                title: 'Takeover Purchase Requisition',
                fieldDefaults: {
                    msgTarget: 'side',
                    labelAlign: 'right',
                    labelWidth: 145
