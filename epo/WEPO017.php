...
{   
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        {
            if($poScreen == 'EditPoAfterClosedScreen')
            {
                ...
                if($poNoSession == $paramPoNo)
                {
                    ...
                    $query = "select 
                                ...
                                ,(select count(*)
                                    ...
                                    where 
                                        PO_NO = '$paramPoNo') 
                                as COUNT_RECEIVING
                                ,EPS_M_EMPLOYEE.PLANT as PO_ISSUER_PLANT
                            from
                                EPS_T_PO_HEADER
                            left join
                                EPS_M_SUPPLIER
                    ...
                    while($row = $sql->fetch(PDO::FETCH_ASSOC)){
                        ...
                        $poIssuerPlant  = $row['PO_ISSUER_PLANT'];
...
<html>
    <head>
        ...
        <script src="../js/epo/WEPO017.js"></script>
        <script>
            maximize();
        </script>
        <title>EPS</title>
                                ...
                                <table class="table table-striped table-bordered" id="poItemTable">
                                    ...
                                    {  
                                        ...
                                        <tr id="<?php echo $seqPoItemSession;?>">
                                            ...
                                            <td class="td-actions-2columns" style="display: none">
                            ...
                            <div class="widget-content">
                                <div class="control-group">	
                                    <table class="table-non-bordered">
                                            ...
                                            <td>
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" name="radioAction" value="updateClosedMonth" /> <p style="font-size: 11px;">Change Closing Month</p>
                                                    </label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" name="radioAction" value="updatePoStatus" /> <p style="font-size: 11px;">Change PO Status </p>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label class="control-label" for="newClosingMonth">New Closing Month (** i.e 201604): </label>
                                                <div class="controls">
                                                    <input type="text" class="span3" id="newClosingMonth" readonly="readonly" />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="newPoStatus">PO Status: </label>
                                                <div class="controls">
                                                    <select id="newPoStatus" class="span4" name="newPoStatus" disabled>
                                                        <option value=""></option>
                                                    <?php 
                                                        $query = "select 
                                                                    APP_STATUS_CD 
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $poStsCd;?>"><?php echo $poStsName;?></option>
                                                    <?php         
                                                        }
                                                    ?>
                                                    </select>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="full-width-input" id="remarkCancelPo" maxlength="200" readonly="readonly" />
                                                </div>
                                            </td>
                                        </tr>  
                                    </table>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        {
                                        ?>
                                        <button class="btn btn-warning" id="btn-update-po-closed">Update PO Closed</button>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <div class="alert" id="mandatory-msg-2" style="display: none">
                                        <strong>Mandatory!</strong> Please input Comment for Update PO Closed.
                                    </div>
                                    <div class="alert" id="mandatory-msg-3" style="display: none">
                                        <strong>Mandatory!</strong> Please input New Closing Month for Change Closing Month action.
                                    </div>
                                    <div class="alert" id="mandatory-msg-4" style="display: none">
                                        <strong>Mandatory!</strong> Please input New PO Status for Change PO Status action.
                                    </div>
                                    <div class="alert" id="mandatory-msg-5" style="display: none">
                                        <strong>Mandatory!</strong> Please select action.
                                    </div>
                                    ...
                                    <div class="alert alert-success" id="update-msg" style="display: none">
                                        <strong>Success!</strong> Update PO finished.
                                    </div>
