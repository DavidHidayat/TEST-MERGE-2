...
<html>
    <head>
        ...
        <script src="../js/ero/WERO003.js"></script>
        <script>
            $(function() {
            ...
            <div class="row">
                <div class="span12"> 
                    ...
                    <div class="alert" id="mandatory-msg-1" style="display: none">
                        <strong>Mandatory!</strong> Please fill at least one criteria search.
                    </div>
                    <?php
                    if($poNoCriteria)
                    {
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                <a href="../db/Redirect/RO_Screen.php?criteria=roClose&paramPoNo=<?php echo $poNo;?>" class="faq-list">
                                                    <?php echo $poNo;?>
                                                </a>
											<?php        
                                                }
                                            ...
                                            <?php
                                                if($sRoleId == 'ROLE_03' || $sRoleId == 'ROLE_04' || $sRoleId == 'ROLE_06')
                                                {
                                                    if($roStatusName == 'Closed')
                                                    {
                                            ?>
                                                        <a href="../db/Redirect/RO_Screen.php?criteria=roDetailClosed&paramRefTransferId=<?php echo $refTransferId;?>&paramPoNo=<?php echo $poNo?>" class="faq-list">
                                                            <?php echo $itemName;?>
                                                        </a>
                                            <?php             
                                                    }
