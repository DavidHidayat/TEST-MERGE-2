...
{       
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        {
            if($roScreen == 'EditClosedRoScreen')
            {
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="td-actions" colspan="10" style="text-align: left">
                                                <a href="#" class="btn btn-small btn-success" id="window-open">
...
<div id="dialog-form" title="Open Received Qty" style="display: none;">
            ...
            <div class="widget-content">
                <div class="control-group">
                    ...
                    <table class="table-non-bordered" id="table-supplier-ref">
                        <tr>
                            <td>
                                <label class="control-label" for="openDate">Date: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="openDate" class="span3" readonly disable />
                                </div>
                            </td>
                            <td>
                                <label class="control-label" for="openQty">Qty: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="openQty" class="span2" maxlength="5" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <label class="control-label" for="openRemark">Remark: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="openRemark" class="full-width-input" maxlength="200" />
                                </div>
                            </td>
                        </tr>
                    </table>
