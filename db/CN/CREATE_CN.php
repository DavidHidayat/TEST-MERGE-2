...
//                                                                echo $query_insert_t_wccncpp;
						...
						$totalTaxPoAmount= ($totalPoAmountSupplier * 0.11);
...
//						$result_call_cl = odbc_exec($conn_as,$query_call_as400_cl);
						 ...
						 * SEND MAIL _ FINISH
						 *********************************************************/
						$mailTo_2         = $procMailCriteria.",KARYOTO@taci.toyota-industries.com,wiharyo@taci.toyota-industries.com, ahmadjafar@taci.toyota-industries.com, bayu.thr@taci.toyota-industries.com, ANDRY@taci.toyota-industries.com, muh.iqbal@taci.toyota-industries.com";
