                                ...
                                <table class="table table-striped table-bordered" id="poItemTable">
                                    ...
                                    $query = "select 
                                        ...
                                        while($row = $sql->fetch(PDO::FETCH_ASSOC)){ 
                                            ...
                                            $itemCategorySession    = $row['ITEM_CATEGORY'];  
                                            $qtySession             = $row['QTY'];
                                        ...
                                        <tr id="<?php echo $seqPoItemSession;?>">
                                            ...
                                            <td data-item-category="<?php echo $itemCategorySession;?>" class="<?php echo $itemCategorySession!='Y'?'':'text-primary'; ?>">
                                                <?php echo $itemCategorySession!='Y'?'NON ':''; ?>ROUTINE
                                            </td>
                                            <td>
