...
{      
    ...
    {  
        ...
        $itemCategory       = strtoupper(trim($_GET['itemCategoryPrm']));
        $validateItemName   = 0;
...
//            }
            ...
            else
            {
                ...
                $prItem[$indexItem]['itemCategory'] = $itemCategory;
                ...
                foreach (array_values($_SESSION['prItem']) as $i => $value) 
                {
                    ...
                    $deliveryDateVal    = $value['deliveryDate'];
                    $remarkVal          = $value['remark'];
                    $itemCategoryVal    = $value['itemCategory'];
                    ...
                    $_SESSION['prItem'][$i]['itemCategory']     = $itemCategoryVal;
                    if($i == 0)
                    {
                        $prItemTable = "<tr>"
                                            ."<td style='text-align: right;'>".$itemSeqHidden."</td>"
