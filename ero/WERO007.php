				...
				if($refTransferIdSession == $transferId && $poNoPrm == $poNoSession)
                {
                    if($sRoStatus != '')
                    {
                        ...
                        while($row_select_t_po_detail = $sql_select_t_po_detail->fetch(PDO::FETCH_ASSOC)){
                            ...
                            $totalCancelQty = $row_select_t_po_detail['TOTAL_CANCEL_QTY'];
...
<html>
    <head>
        ...
        <script src="../js/ero/WERO007.js"></script>
        <script>
            $(function() {
                                ...
                                <table class="table table-striped table-bordered" id="receivingListTable">
                                    <thead>
                                        <tr>
                                            <th class="td-actions" colspan="10" style="text-align: left">
                                                <a href="#" class="btn btn-small btn-danger" id="window-cancel">
                                        ...
                                        <tr>
                                            ...
                                            <th style="display: none">TRANSACTION FLAG</th>
                                    ...
                                    if(strlen($_SESSION['roDetail']) > 0){
                                        ...
                                        { 
                                            ...
                                            $roRemarkSession        = strtoupper($roDetail['roRemark']);
                                    ...
                                    ?>
                                        <tr id="<?php echo $receivedSeqSession;?>">
                                            ...
                                            <td style="display: none">
                                                <?php echo $transactionFlagSession; ?>
                                            </td>
                                            <td>
...
<div id="dialog-form" title="Cancel Received Qty" style="display: none;">
    ...
    <div class="alert" id="dialog-mandatory-msg-3" style="display: none;">
        <strong>Mandatory!</strong> Please input cancel qty < total received qty
    </div>
            ...
            <div class="widget-content">
                <div class="control-group">
                    ...
                    <table class="table-non-bordered" id="table-supplier-ref">
                        <tr>
                            <td>
                                <label class="control-label" for="cancelDate">Date: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="cancelDate" class="span3" readonly disable />
                                </div>
                            </td>
                            <td>
                                <label class="control-label" for="cancelQty">Qty: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="cancelQty" class="span2" maxlength="5" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <label class="control-label" for="cancelRemark">Remark: </label>
                                <div class="dialog-controls">
                                    <input type="text" id="cancelRemark" class="full-width-input" maxlength="200" />
                                </div>
                            </td>
                        </tr>
                    </table>
