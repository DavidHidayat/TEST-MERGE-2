                    ...
                    if($itemStatusSesssion == '1130' || $itemStatusSesssion == '1170')
                    {
                        ...
                        $query = "select 
                                ...
                                left join
                                    EPS_M_ITEM_PRICE
                                on
                                    EPS_T_TRANSFER.NEW_ITEM_CD = EPS_M_ITEM_PRICE.ITEM_CD ";
                                ...
                                <div class="control-group">	
                                    <table class="table-non-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <label class="control-label" for="priceSet">CATG.: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2 input-align-right" id="price" value="<?php echo $itemCategory!='Y'?'NON ':''; ?>ROUTINE" readonly />
                                                </div>	
                                            </td>
                                        </tr>
                                        <tr>
