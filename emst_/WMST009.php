...
{      
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        if($sRoleId == 'ROLE_03' || $sRoleId == 'ROLE_07' || $roleId = 'ROLE_04')
        {
                ...
                if(!empty($fileName))
                {
                    if($fileType=="application/vnd.ms-excel")
                    {
                        ...
                        for ($x = 2; $x <= $rowData; $x++)
                        {
                            ...
                            $leadTime       = trim($data->val($x, 8));
                            $objectAccount       = trim($data->val($x, 9));
                            ...
                            $uploadId = 'REG'.$currentDate.$sequencesNo;
                                                                    ...
                                                                    if($itemPrice > 0)
                                                                    {
                                                                        if($row_select_m_unitCd)
                                                                        {
                                                                            if($row_select_m_itemGroup)
                                                                            {
                                                                                ...
                                                                                $uploadItemStatus = 'E';
                                                                                $msgError = 'Existence Error. Category is not found.';
                                                                                $countError++;
                                                                            }
                                                                        }else{
                                                                            $uploadItemStatus = 'E';
                        ...
                        while($row_upload = $sql_upload->fetch(PDO::FETCH_ASSOC)){
                            ...
                            $itemName       = trim($row_upload['ITEM_NAME']);
                        ...
                        else
                        {
                            if($countError == 0)
                            {
                                ...
                                while($row_select_m_item_upload = $sql_select_m_item_upload->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    $itemName       = strtoupper(trim($row_select_m_item_upload['ITEM_NAME']));
                                    $itemName       = str_replace("'", "''", $itemName);
                                    $itemName       = preg_replace("/\r\n+|\r+|\n+|\t+/i", " ", $itemName);
                                    $itemName       = preg_replace('/\s+/', ' ',$itemName);
                                    ...
                                    $objectAccount = $row_select_m_item_upload['OBJECT_ACCOUNT_CD'];
...
<html>
    <head>
        ...
        <script src="../js/emst/WMST009.js"></script>
        <script>
            maximize();
        </script>
        <title>EPS</title>
                ...
                <div class="span12"> 
                    ...
                    <div class="widget ">
                        <div class="widget-header">
                            ...
                            <h3>Upload (Register Item Price)</h3>
                        </div>
                        <div class="widget-content">
                            <form id="WMST009Form"  method="post" enctype="multipart/form-data" action="WMST009.php">
                            ...
                            ** Click here to download example file to upload <a href="../lib/FORMAT_UPLOAD_PRICE_LIST.xls">Register Item Price Master </a>
                    ...
                    <div class="widget-header">
                        ...
                        <div class="widget-content">
                            ...
                            <table class="table" >
                                <tr>
                                    <td colspan="6">
                                        <div class="alert" id="dialog-alert" style="display: none;">
                                ...
                                <tr>
                                    <td>                                    
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span2" id="itemName" name="itemName" role="master" />
                                        </div>
                                    </td>
                                    <td>                                    
                                        <label class="control-label" for="itemCd">Item Code: </label>
                                        <div class="controls">
                                            <input type="text" class="span2" id="itemCd" name="itemCd" readonly />
                                        </div>
                                    </td>
                                    <td>                                    
                                    ...
                                    <td>                                    
                                        ...
                                        <div class="controls">
                                            <input type="number" class="span2 numbers-only" id="leadTime" name="leadTime"  />
                                        </div>
                                    </td>
                                    <td>                                    
                                        <label class="control-label" for="supplierName">Supplier Name: </label>
                                        <div class="controls">
                                            <input type="text" class="span2" id="supplierName" name="supplierName"  />
                                        </div>
                                    </td>
                                    <td>                                    
                                        <label class="control-label" for="supplierCd">Supplier Code: </label>
                                        <div class="controls">
                                            <input type="text" class="span2" id="supplierCd" name="supplierCd" readonly/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>                                    
                                        <label class="control-label" for="quotation">Attachment Quotation (YYYY/DD/FILE NAME): </label>
                                        <div class="controls">
                                            <input type="text" class="span2" id="quotation" name="quotation"  />
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dialog-controls">
                                            ...
                                            <?php
                                                ...
                                                while($row = $sql->fetch(PDO::FETCH_ASSOC)){
                                            ?>
                                                <option value="<?php echo $row['CURRENCY_CD'];?>"><?php echo $row['CURRENCY_NAME'];?></option>
                                            <?php         
                                                }
                                            ?>
                                            </select>
                                    ...
                                    <td>                                    
                                        ...
                                        <div class="controls">
                                            <input type="number" class="span2 numbers-only" id="itemPrice" name="itemPrice"  />
                                        </div>
                                    </td>
                                    <td>
                                        <label class="control-label" for="itemCategory">Category: </label>
                                        <div class="controls">
                                            <select id="itemCategory" class="span2" name="itemCategory">
                                                <option value="Y">ROUTINE</option>
                                    ...
                                    <td>
                                        ...
                                        <div class="controls">
                                        <input type="text" class="span1" id="effectiveDateFrom" name="effectiveDateFrom" />
                                        -
                                        <input type="text" class="span1" id="effectiveDateEnd" name="effectiveDateEnd"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="5">
                                        <button class="btn btn-primary" id="btn-save" style="margin-top: 10px;">Save</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
