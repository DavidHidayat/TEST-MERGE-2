...
if(count($wherePoSelect)) {
    $query_select_t_po_detail .= " and " . implode(' and ', $wherePoSelect);
}
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('EPS_Delay_Delivery');
...
header('Content-Disposition: attachment;filename="EPS_Delay_Delivery.xlsx"');
