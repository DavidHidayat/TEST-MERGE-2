...
?>
                        <script language="javascript">
                            document.location = "../ecom/WCOM013.php";
                        </script>
                    <?php
                    }
                } else {
    ...
    <div class="main">
                ...
                <div class="row">
                    <div class="span12">
                        ...
                        <div class="alert" id="mandatory-msg-3" style="display: none">
                            <strong>Failure!</strong> Please input receiving qty <= PO qty. </div>
        ...
        <div id="dialog-form" title="Add Received Qty" style="display: none;">
            ...
            <div class="alert" id="dialog-mandatory-msg-3" style="display: none;">
                <strong>Mandatory!</strong> Please input received qty <= total received qty </div>
