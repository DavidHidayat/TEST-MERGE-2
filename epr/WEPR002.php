    ...
    <head>
        ...
        var mainLayout = function(){
            ...
            var ext = new Ext.form.TextField({
                ...
                maskRe: /[\d\-]/,
                regex: /^\d{3}$/,
                regexText: 'Must be in the format xxx (i.e 924)',
                allowBlank: false,
                flex: 2
            });
                ...
                listeners: {
                    change: function(){
                        ...
                        if(valItemType=='1'){
                            ...
                            prChargedItemForm.setVisible(false);
                            prChargedItemForm.allowBlank=true;
                            prChargedItemForm.reset();
                            ...
                            prChargedItemForm.reset();
                                ...
                                prChargedItemForm.setVisible(true);
                                prChargedItemForm.allowBlank=false;
                ...
                columns: [{
                    ...
                    columns: [{
                        ...
                        /*,getClass: function(v,meta,rec){
                            ...
                            var countAttach=0;
                            for(var i = 0; i < myAttachmentTemp.length; i++){
                                var itemName = myAttachmentTemp[i][1];
                                if(value == itemName){
                                    countAttach++;
                                }
                            }
                            ...
                            if(countAttach > 0){
                                //return meta.tdCls = 'view_attachment'
                            }else{
                                //return meta.tdCls = 'view_blank'
                            }
                        },
                        renderer: function viewAttachment (value, metaData, record, row, col, store, gridView) {
                            var countAttach=0;
                            for(var i = 0; i < myAttachmentTemp.length; i++){
                                var itemName = myAttachmentTemp[i][1];
                                if(value == itemName){
                            ...
                            if(countAttach > 0){
                                return '<img src=../images/attach16.png>'
                            }
                        },*/
                    }]
                },{
