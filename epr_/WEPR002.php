...
{      
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        $dirName = $_SERVER['DOCUMENT_ROOT']."/".substr($_SERVER['REQUEST_URI'],1,strpos(substr($_SERVER['REQUEST_URI'],1),'/'))."/db/ATTACHMENT/TEMPORARY/$currentMonth/$sUserId/";
                    ...
                    <div class="widget widget-table action-table">
                        ...
                        <div class="widget-content">
                            <table class="table table-striped table-bordered" id="prItemTable">
                                <thead>
                                    <tr id="tr-first-item">
                                        <th class="td-actions" colspan="15" style="text-align: left">
...
<!--                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div>
                                    <label class="control-label" for="itemName">Item Name (MAKER,NAME,SPEC): </label>
                                    <div class="controls">
                            ...
                            <td>
                            <div>
                                    <label class="control-label" for="itemCategory">CATG. : </label>
                                    <div class="controls">
                                        <input type="text" id="itemCategory" class="form-control" maxlength="200" readonly />
                                    </div>
                                </div>
                            </td>
                        </tr>
        ...
        <div style="width: 100%; text-align:center;">
            <img src="<?php echo BASE_URL;?>/images/timeline.png" alt="">
        </div>
