    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        if($sRoleId == 'ROLE_03' || $sRoleId == 'ROLE_04' || $sRoleId == 'ROLE_05' || $sRoleId == 'ROLE_06' || $sRoleId == 'ROLE_09' || $sRoleId == 'ROLE_11')
        {
            ...
            */
            ...
            if($sRoleId == 'ROLE_02' || $sRoleId == 'ROLE_04' || $sRoleId == 'ROLE_05' || $sRoleId == 'ROLE_09')
            {
            ...
            if($supplierCdCriteria || $supplierNameCriteria 
                            || $poNoCriteria || $requesterCriteria || $prNoCriteria)
            {
                if($supplierCdCriteria){
                    $wherePoDetail[] = "EPS_T_PO_HEADER.SUPPLIER_CD = '".$supplierCdCriteria."'";
                }
                if($supplierNameCriteria){
                    $wherePoDetail[] = "EPS_T_PO_HEADER.SUPPLIER_NAME = '".$supplierNameCriteria."'";
                }
                if($poNoCriteria){
                    $wherePoDetail[] = "EPS_T_PO_DETAIL.PO_NO = '".$poNoCriteria."'";
                }
                if($requesterCriteria){
                    $wherePoDetail[] = "EPS_M_EMPLOYEE.NAMA1 like '".$requesterCriteria."%'";
                }
                if($prNoCriteria){
                    $wherePoDetail[] = "EPS_T_TRANSFER.PR_NO = '".$prNoCriteria."'";
                }
            }
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="19" style="text-align: left">
                                            ...
                                            <a href="../db/REPORT/DELAY_DELIVERY.php?supplierCd=<?php echo trim($supplierCdCriteria);?>
                                                   &supplierName=<?php echo $supplierNameCriteria;?>&poNo=<?php echo trim($poNoCriteria);?>
                                                   &requester=<?php echo $requesterCriteria;?>&prNo=<?php echo trim($prNoCriteria);?>" target="_blank" class="btn btn-small btn-linkedin-alt">
                                                Download
                                                <i class="btn-icon-only icon-download-alt"> </i>
                                            </a>
                                        </th>
