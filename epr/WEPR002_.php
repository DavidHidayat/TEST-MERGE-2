						...
						if(qty <= 0 || itemPrice <= 0 || amount <=0 ){
							...
							if(action=='Edit'){
								...
								if(id=='2'){ // cek apakah value di grid == value di form
									myItem[oldItemName]=[itemCd,itemName,remark, deliveryDate,itemType,rfiNo,accountNo,currencyCd,supplierCd,supplierName,unitCd,qty,itemPrice,amount,itemStatus,reasonToReject,rejectItemBy,rejectItemName,remark2];
								...
								if(id=='2'){
									myItem.push([itemCd,itemName,remark, deliveryDate,itemType,rfiNo,accountNo,currencyCd,supplierCd,supplierName,unitCd,qty,itemPrice,amount,itemStatus,reasonToReject,rejectItemBy,rejectItemName,remark2]);
