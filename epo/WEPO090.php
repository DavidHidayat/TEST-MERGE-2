...
{ 
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        if($sRoleId == 'ROLE_02' || $sRoleId == 'ROLE_03' || $sRoleId == 'ROLE_04' || $sRoleId == 'ROLE_06' || $sRoleId == 'ROLE_07' || $sRoleId == 'ROLE_09' || $sRoleId == 'ROLE_10' || $sRoleId == 'ROLE_11')
        {
            ...
            $deliveryPlantCriteria      = trim($_GET['deliveryPlantCriteria']);
            $poIssuedByCriteria         = trim($_GET['poIssuedByCriteria']);
            $poApproverCriteria         = trim($_GET['poApproverCriteria']);
            ...
            $sentPoDateCriteria   	= trim($_GET['sentPoDateCriteria']);
            ...
            $closedPoMonthCriteria  	= trim($_GET['closedPoMonthCriteria']);
            $cnNoCriteria               = trim($_GET['cnNoCriteria']);
            
            if($poNoCriteria || $poDateCriteria || $poDateEndCriteria 
                    || $deliveryDateCriteria || $requesterCriteria || $prNoCriteria 
                    || $supplierCdCriteria || $supplierNameCriteria || $deliveryPlantCriteria
                    || $poIssuedByCriteria || $poApproverCriteria || $itemTypeCriteria
                    || $expNoCriteria || $invNoCriteria || $rfiNoCriteria
                    || $itemStatusCriteria || $prChargedCriteria || $poStatusCriteria
                    || $sentPoDateCriteria || $roStatusCriteria || $itemNameCriteria 
                    || $currencyCdCriteria || $closedPoMonthCriteria || $cnNoCriteria)
            {
                if(isset($_GET['mpage']))
                {
                        ...
                        <div class="widget-content">
                            <form id="WEPO090Form">
								...
								order by 
                                                    ...
                                                    <input type="text" class="span4" value="<?php echo $supplierNameCriteria;?>" id="supplierName" name="supplierNameCriteria"  />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="deliveryPlant">Delivery Plant: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="deliveryPlant" name="deliveryPlantCriteria" maxlength="2" value="<?php echo $deliveryPlantCriteria;?>"  />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="poIssuedBy">PO Issuer: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="poIssuedBy" name="poIssuedByCriteria" maxlength="10" value="<?php echo $poIssuedByCriteria;?>" />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="poApprover">PO Approver: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="poApprover" name="poApproverCriteria" maxlength="20" value="<?php echo $poApproverCriteria;?>" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="control-label" for="sentPoDate">Sent PO Date: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="sentPoDate" name="sentPoDateCriteria" maxlength="8" value="<?php echo $sentPoDateCriteria;?>" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span4" id="itemName" name="itemNameCriteria" value="<?php echo $itemNameCriteria;?>" />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="currencyCd">Currency: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="currencyCd" name="currencyCdCriteria" maxlength="3" value="<?php echo $currencyCdCriteria;?>" />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="closedPoMonth">Closing PO Month: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="closedPoMonth" name="closedPoMonthCriteria" maxlength="8" value="<?php echo $closedPoMonthCriteria;?>" />
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="cnNo">CN NO: </label>
                                                <div class="controls">
                                                    <input type="text" class="span2" id="cnNo" name="cnNoCriteria" maxlength="8" value="<?php echo $cnNoCriteria;?>" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th colspan="21" style="text-align: left">
												<a href="../db/REPORT/PO_SEARCH.php?poNo=<?php echo trim($poNoCriteria);?>
                                                   ...
                                                   &deliveryDate=<?php echo $deliveryDateCriteria;?>&requester=<?php echo $requesterCriteria;?>
                                                   &prNo=<?php echo trim($prNoCriteria);?>&supplierCd=<?php echo trim($supplierCdCriteria);?>
                                                   &supplierName=<?php echo $supplierNameCriteria;?>&deliveryPlant=<?php echo $deliveryPlantCriteria;?>
                                                   &poIssuedBy=<?php echo $poIssuedByCriteria;?>&poApprover=<?php echo $poApproverCriteria;?>
                                                   &itemType=<?php echo $itemTypeCriteria;?>&expNo=<?php echo $expNoCriteria;?>
                                                   &rfiNo=<?php echo $rfiNoCriteria;?>&invNo=<?php echo trim($invNoCriteria);?>
                                                   &itemStatus=<?php echo $itemStatusCriteria?>&prCharged=<?php echo $prChargedCriteria;?>
                                                   &poSts=<?php echo $poStatusCriteria;?>&sentPoDate=<?php echo trim($sentPoDateCriteria);?>
                                                   &roSts=<?php echo $roStatusCriteria;?>&itemName=<?php echo trim($itemNameCriteria);?>
                                                   &currencyCd=<?php echo $currencyCdCriteria;?>&closedPoMonth=<?php echo trim($closedPoMonthCriteria);?>&cnNo=<?php echo $cnNoCriteria;?>" class="btn btn-small btn-linkedin-alt" target="_blank">
                                                    Download
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="2">DELAY<br/>OUTFLAG</th>
                                        </tr>
                                        <tr>
                                            <th>PO NO</th>
                                            <th>STATUS</th>
                                    ...
                                    while($row_t_ro_select_2 = $sql_t_ro_select_2->fetch(PDO::FETCH_ASSOC))
                                    {
                                        ...
                                        $itemCategory   = $row_t_ro_select_2['ITEM_CATEGORY'];
                                        ...
                                        $countDateDiff  = $row_t_ro_select_2['COUNT_DATE_DIFF'];
                                            ...
                                            <?php
                                                ...
                                                {    
                                                    ...
                                                    if ($query_t_po_select != "")
                                                    {
                                                        ...
                                                        $fld .= "&deliveryPlantCriteria=$deliveryPlantCriteria";
                                                        $fld .= "&poIssuedByCriteria=$poIssuedByCriteria";
                                                        $fld .= "&poApproverCriteria=$poApproverCriteria";
                                                        ...
                                                        $fld .= "&sentPoDateCriteria=$sentPoDateCriteria";
                                                        $fld .= "&roStsCriteria=$roStatusCriteria";
                                                        $fld .= "&itemNameCriteria=$itemNameCriteria";
                                                        $fld .= "&currencyCdCriteria=$currencyCdCriteria";
                                                        $fld .= "&closedPoMonthCriteria=$closedPoMonthCriteria";
                                                        $fld .= "&cnNoCriteria=$cnNoCriteria";
                                                        $fld .= "&mpage";
                                                    }
                                                    else
                                                    {
