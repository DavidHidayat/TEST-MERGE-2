    ...
    if(trim($sUserId) != '')
    {
		...
		$row = $sql->fetch(PDO::FETCH_ASSOC);
                    ...
                    **/ 
					...
					$mailTo         = $supplierMail;
                    //$mailTo         = "byan_purba@denso.co.id";
                    $mailCc         = "karyoto@taci.toyota-industries.com,i.softwan@taci.toyota-industries.com,wiharyo@taci.toyota-industries.com".",".$issuedMail;
            ...
            if($updateDate == $newUpdateDate)
            {
                if($newDeliveryDate != "" && $remarkCancelPo != "")
                {
                    ...
                    **/ 
                    ...
                    $mailTo         = $supplierMail;
                    $mailCc         = $issuedMail.","."ahmadjafar@taci.toyota-industries.com,karyoto@taci.toyota-industries.com,i.softwan@taci.toyota-industries.com,wiharyo@taci.toyota-industries.com";
