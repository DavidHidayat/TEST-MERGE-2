...
<html>
    <head>
        ...
        <script src="../js/ecn/WECN001.js"></script>
        <title>EPS</title>
    </head>
    <body> 
                ...
                <div class="span12"> 
                    ...
                    <div class="widget ">
                        <div class="widget-header">
                            ...
                            <h3>Credit Notes Transfer</h3>
                        </div>
                        <div class="widget-content">
                            <div class="alert alert-info">
                                <strong>Information!</strong> This screen has purpose to transfer PO from EPS to AS400 during closing process.
                            </div>
                            <form id="WERO001Form">
                            ...
                            ?>
                                <div>
                                    <button class="btn btn-warning" id="btn-cn-process">CN TRANSFER PROCESS</button> 
                                </div> 
                            <?php    
                            }
                            else
                            ...
                            ?>
                                <div>
                                    <button class="btn btn-warning" id="btn-cn-process" disabled>CN TRANSFER PROCESS</button> 
                                </div>
                            <?php    
                            }
                            ?> 
                            ...
                            <div class="alert" id="mandatory-msg-2" style="display: none">
                                <strong>Failure!</strong> Transfer PO from EPS to AS400 failed because different count record during closing process.<br>Please contact EPS Administrator to confirm transfer process.
                            </div>
                            <div class="alert" id="mandatory-msg-3" style="display: none">
                                <strong>Failure!</strong> Please input closing month greater than 201508.
                            </div>
                            ...
                            <div class="alert alert-success" id="transfer-msg" style="display: none">
                                <strong>Success!</strong> Transfer PO from EPS to AS400 finished.<br>Please contact EPS Administrator to confirm next process.
                            </div>
                        </div>
                    </div>
                </div>
