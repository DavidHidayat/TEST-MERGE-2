...
<html>
    <head>
        ...
        var mainLayout = function(){
            var toolbarTop = new Ext.Toolbar ({
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        text: 'Main Screen',
                        handler: function(){
                            Ext.Msg.alert('Message','Sorry, you cannot change menu during in Replicate PR Screen. <br>Please choose action "Send or Save or Cancel Create PR".');
                        }   
                    }]
                },{
                    xtype: 'buttongroup',
            ...
            var winPrAttachment;
            var itemNameGet;
            var urlPrDetail         = '<?php echo "../db/PR/READ_PR.php?prNo=".$oldPrNo."&param=prDetailReplicate" ?>';
            var urlPrAttachment     = '<?php echo "../db/PR/READ_PR.php?prNo=".$oldPrNo."&param=prAttachment&action=edit" ?>';
                        ...
                        if(qty <= 0 || itemPrice <= 0 || amount <=0 ){
                            ...
                            if(action=='Edit'){
                                ...
                                if(id=='2'){ // cek apakah value di grid == value di form
                                    myItem[oldItemName]=[itemCd,itemName,remark , remark2,deliveryDate,itemType,rfiNo,accountNo,currencyCd,supplierCd,supplierName,unitCd,qty,itemPrice,amount, rutin, subtitusi, prChargedItem ,itemStatus,reasonToReject,rejectItemBy,rejectItemName];
                                ...
                                if(id=='2'){
                                    myItem.push([itemCd,itemName,remark,remark2,deliveryDate,itemType,rfiNo,accountNo,currencyCd,supplierCd,supplierName,unitCd,qty,itemPrice,amount, rutin, subtitusi,prChargedItem,itemStatus,reasonToReject,rejectItemBy,rejectItemName]);
            ...
            var specialType = Ext.create('Ext.form.RadioGroup',{
                ...
                listeners: {
                    change: function(a){
                        ...
                        if(valSpecialType=='IT' && Ext.String.trim(valBuCd) != '3300'){
            ...
            var ext = new Ext.form.TextField({
                ...
                maskRe: /[\d\-]/,
                regex: /^\d{3}$/,
                regexText: 'Must be in the format xxx (i.e 925)',
                allowBlank: false,
                flex: 2
            });
...
//                value: '<?echo $sBuLogin ?>',
            ...
            **/
            ...
            var panelCenter = Ext.create('Ext.form.Panel', {
                border: false,
                frame: true,
                title: 'Replicate Purchase Requisition',
                fieldDefaults: {
                    msgTarget: 'side',
                    labelAlign: 'right',
                    labelWidth: 135
