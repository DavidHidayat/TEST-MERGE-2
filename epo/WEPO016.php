...
{      
    ...
    if($sUserId != '' && $sActiveFlag == 'A' && $sActiveFlagLogin == 'A')
    {
        ...
        {
            //if($sProcInCharge == $sUserId)
            //{
				if($prScreen == 'EditWaitingPrScreen')
                {
            ...
            //{
            ?>
                <!--<script language="javascript"> alert("Sorry, you are not Proc In Charge for this PR No.");
...
<html>
    <head>
        ...
        <script src="../js/epo/WEPO016.js"></script>
        <script>
            maximize();
        </script>
        <title>EPS</title>
            ...
            <div class="row">
                <div class="span12">  
                    ...
                    <!-- <form>   -->
                        ...
                        <input type="hidden" value="<?php echo $sUserId;?>" id="userId" readonly />
                        <input type="hidden" value="<?php echo $sUserId;?>" id="userId" readonly />
                                ...
                                <div class="control-group">	
                                    <table class="table-non-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="control-label" for="newPrCharged">Charged BU: </label>
                                                <div class="controls">
                        ...
                        <div class="widget widget-table action-table">
                            ...
                            <div class="widget-content">
                                <table class="table table-striped table-bordered" id="prItemTable">
                                    <thead>
                                        <tr>
                                            <th colspan="15" style="text-align: right; color: #3F85F5">
                            ...
                            <div class="widget-content">
                                <div class="control-group">	
                                    <table class="table-non-bordered">
                                        <tr>
                                            <td>
                                                <label class="control-label" for="remarkProc">Proc. In Charge: </label>
                                                <div class="controls">
                                                    <input type="text" id="procInCharge" value="<?php echo $procInChargeName?>" readonly />    
                                                </div>
                                            </td>
                                            <td>
                                                <label class="control-label" for="remarkProc">New Proc. In Charge: </label>
                                                <div class="controls">
                                    ...
                                    <div class="alert alert-success" id="success-msg" style="display: none">
                                        <strong>Success!</strong> Update PR finished.
                                    </div>
